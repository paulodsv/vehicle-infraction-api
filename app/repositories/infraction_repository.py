...
class InfractionRepository():
    ...
    def save_query(self, query_data: InfractionQueryCreate):
    ...
    def get_infractions_by_plate(self, plate: str):
        return self.db.query(Infractions).filter(Infractions.plate == plate).all()
    
    def update_infraction_details(self, detailed_infraction: InfractionDetailedCreate, infraction_notice_number: str):
